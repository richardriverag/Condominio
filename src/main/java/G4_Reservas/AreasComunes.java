 ...
 * @author ASUS
 */
public class AreasComunes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Área de Picnic", "DISPONIBLE", "", null},
                {"Canchas Múltiples", "RESERVADO", "7:00", "13:00"},
                {"Gimnasio", "DISPONIBLE", null, null},
                {"Parque", "DISPONIBLE", null, null},
                {"Parqueadero", "RESERVADO", "8:00", "20:00"},
                {"Salón Comunal", "DISPONIBLE", "", null}
            },
            new String [] {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AreasComunes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AreasComunes().setVisible(true);
            }
        });
    }
