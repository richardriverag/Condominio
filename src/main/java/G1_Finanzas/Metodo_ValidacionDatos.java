...
//        // Patrón para verificar si el código de usuario cumple con el formato esperado
//       // Pattern patron = Pattern.compile("^USR\\d+$");
//        //Matcher matcher = patron.matcher(codigoUsuario);
//
//        // Verificar si el código de usuario coincide con el patrón
...
//    } 
//    
//    // Método para mostrar el mensaje de error y verificar si un campo está vacío
