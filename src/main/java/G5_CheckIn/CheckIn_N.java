 ...
 * @author Usuario
 */
public class CheckIn_N extends javax.swing.JFrame {
    ...
    public CheckIn_N(String parqueadero) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckIn_N.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
